...
from maze.maze_env.maze_view_2d import MazeView2D
...
# Sample maze environment we generated.
class MazeEnvRegular3x3(MazeEnv):
...
class MazeEnvRegular7x7(MazeEnv):
    
        def __init__(self, enable_render=True):
            super(MazeEnvRegular7x7, self).__init__(maze_file="maze2d_regular_7x7.npy", enable_render=enable_render)

class MazeEnvRegular9x9(MazeEnv):
    
        def __init__(self, enable_render=True):
            super(MazeEnvRegular9x9, self).__init__(maze_file="maze2d_regular_9x9.npy", enable_render=enable_render)